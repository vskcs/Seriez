...
<div style="background-color: white !important; opacity:0.8"  class="jumbotron">
    ...
    <h1>VS Koushik</h1>
    <p class="lead">IMtech Student at University of Hyderabad</p>
        <p>  
            <i class="fas fa-map-marker-alt fa-2x"></i>
                Hyderabad, India - 500046 &emsp; &emsp;
            <i class="fas fa-phone mt-4 fa-2x"></i>
                +91 9866713040 &nbsp &emsp; &emsp;      
        ...
        <br>
    <p class="lead">
        <a class="btn btn-primary btn-lg" href="welcome.php" role="button" >Go to Home</a>
    </p>
</div>
</div>
